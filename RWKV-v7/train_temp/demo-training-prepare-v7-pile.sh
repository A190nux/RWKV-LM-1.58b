...
python train.py --wandb "" --proj_dir $PROJ_DIR \
 --data_file "/kaggle/working/data/minipile" --data_type "binidx" --vocab_size 50304 --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --train_stage 1 --epoch_count 1 --epoch_begin 0 \
 --epoch_save 1 --weight_decay 0 --head_size 64 \
 --num_nodes 1 --micro_bsz 1 --n_layer $N_LAYER --n_embd $N_EMBD --my_exit_tokens 1498226207 --magic_prime 81082817 \
